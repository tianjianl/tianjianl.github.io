...
{% include figure.html path="assets/img/mnmt1.png" class="img-fluid rounded z-depth-1 mx-auto d-block" zoomable=true width="391"%}
...
{% include figure.html path="assets/img/mnmt2.png" class="img-fluid rounded z-depth-1 mx-auto d-block" width="602" zoomable=true %}
