...
- Scale up! Language Model pre-training needs to find weights for each domain. [Anil et al., 2022](https://arxiv.org/abs/2305.10403) did a grid search on the weights, which is expensive. There are many open questions: should these weights be static or dynamic? what is the most important factor when findings these weights [[Xie et al., 2023a](https://arxiv.org/abs/2302.03169), [Xie et al., 2023b](https://arxiv.org/abs/2305.10429)] - as simple as size? what about quality? How do we find scalable methods to measure pre-training data quality/diversity? 
